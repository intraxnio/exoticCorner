...
import banksett from "../../images/banksett.svg"
  ...
  return (
    ...
    <div className="container">
     ...
     <div className="container mt-3">
       ...
       <img className="img-fluid rounded" style={{ padding: '42px'}} src={banner3} alt="Business Growth" width={470} height={470} />
...
<div className="row mx-auto">
    ...
    <div className="col-12 col-md-6 col-lg-6">
        <img className="img-fluid rounded" style={{ padding: '42px'}} src={banner2} alt="banner" width={500} height={500} />
    ...
    <div className="container mt-3">
        ...
        <div className="row mx-auto">
          <div className="col-12 col-md-6 col-lg-6 order-2 order-md-0 order-lg-0">
          <img className="img-fluid rounded" style={{ padding: '42px'}} src={banksett} alt="social Media" width={500} height={500} />
        </div>
...
<div className="row mx-auto">
    ...
    <div className="col-12 col-md-6 col-lg-6">
        <img className="img-fluid rounded" style={{ padding: '42px'}} src={banner4} alt="banner" width={500} height={500} />
    </div>
</div>
</div>
...
<div className="col-12 col-md-6 col-lg-6 order-2 order-md-0 order-lg-0">
<img className="img-fluid rounded" style={{ padding: '42px'}} src={banner5} alt="Business Growth" width={500} height={500} />
...
<div className="row mx-auto">
    ...
    <div className="col-12 col-md-6 col-lg-6">
        <img className="img-fluid rounded" style={{ padding: '42px'}} src={banner6} alt="banner" width={500} height={500} />
